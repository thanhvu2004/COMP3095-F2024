...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceRoute() {
        log.info("Initializing product service route: {}", productServiceUrl);
    ...
    public RouterFunction<ServerResponse> orderServiceRoute() {
        log.info("Initializing order service route: {}", orderServiceUrl);
    ...
    public RouterFunction<ServerResponse> inventoryServiceRoute() {
        log.info("Initializing inventory service route: {}", inventoryServiceUrl);
    ...
    public RouterFunction<ServerResponse> fallbackRoute() {
        return route("fallbackRoute")
                .route(RequestPredicates.all(), request ->
                        ServerResponse.status(HttpStatus.SERVICE_UNAVAILABLE).body("Service is down. Please try again later."))
                .build();
    }
}
